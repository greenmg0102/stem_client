...
import ProgramSchoolOrgTypeModal from './ProgramSchoolOrgTypeModal'

import { programTypeRead, programTypeDelete, programTypeUpdate } from '../../../../api/admin/programSchool/type'

const ProgramSchoolOrgType = () => {
    ...
    useEffect(() => {
        async function fetchData() {
            let result = await programTypeRead()
    ...
    const updateItem = async (id: any, status: any) => {
        ...
        let result = await programTypeUpdate(data)
        if (result.isOkay) setTypeResult(result.result)
    }

    const deleteItem = async (id: any) => {
        const data = { id: id }
        let result = await programTypeDelete(data)
        if (result.isOkay) setTypeResult(result.result)
    }
...
export default ProgramSchoolOrgType;