            ...
            <div className="flex justify-between items-start">
                <div className="w-full sm:w-3/4 p-8 flex justify-start items-start flex-wrap shadow-xl border border-gray-200 border-dashed rounded-[8px]">
                    ...
                    <div className="mb-4 mr-8">
                        ...
                        <a href={data.CourseList} className="mb-4 hover:underline">{data.CourseList}</a>
                    </div>
                    <div className="mb-4 mr-8">
                        <p className="font-bold flex mb-2 text-[14px] items-center">
                        ...
                        <a href={data.OpportunityLink} className="mb-4 hover:underline">{data.OpportunityLink}</a>
                    </div>
                ...
                <div className="w-full sm:w-1/4 p-8 shadow-xl border border-gray-200 border-dashed rounded-[8px]">
                    <p className="font-bold flex mb-2 text-[14px] items-center">
