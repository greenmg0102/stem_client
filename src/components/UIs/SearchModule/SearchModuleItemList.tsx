...
const SearchModuleItemList = ({ item }: any) => {
    ...
    return (
        ...
        >
            ...
            {item.SpecificAreaofStudy && item.SpecificAreaofStudy.specificField &&
