...
import { generalStudyFieldCreate } from '../../../../api/admin/generalStudyField'

import 'swiper/css';
import 'swiper/css/navigation';
import 'swiper/css/pagination';

const GeneralFieldOfStudyModal = ({ typeModal, setTypeModal, setTypeResult }: { typeModal: boolean, setTypeModal: any, setTypeResult: any }) => {
    ...
    const saveType = async (isTrue: boolean) => {
        ...
        if (value.length < 1) {
            ...
            let result = await generalStudyFieldCreate(data)
                        ...
                        >
                            <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg my-8 text-black dark:text-white-dark">
                                <div className="flex bg-[#fbfbfb] dark:bg-[#121c2c] items-center justify-between px-5 pt-6">
                                    <h5 className="font-bold text-lg text-gray-600">Please register <span className='font-bold text-gray-900 text-[20px]'>General Field of Study</span>.</h5>
                                        ...
                                        <Tab.Panels>
                                            <Tab.Panel>
                                                <div className="active pt-5">
                                                    ...
                                                    <input type="text" value={value} placeholder="Program School / Org Type..." className="form-input my-4" onChange={(e: any) => setValue(e.target.value)} />
...
export default GeneralFieldOfStudyModal;