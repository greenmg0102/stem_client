...
const SingleClassification = lazy(() => import('../pages/Admin/ProgramSchool/SingleClassification'));
const StemAdmin = lazy(() => import('../pages/Admin/ProgramSchool/Stem'));
...
const routes = [
    ...
    },
    {
        ...
        element: <CredentialAdmin />,
    },
    {
        path: '/admin/single-classification',
        element: <SingleClassification />,
    },
    {
        path: '/admin/stem',
        element: <StemAdmin />,
