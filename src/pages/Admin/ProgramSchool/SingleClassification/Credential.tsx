...
import { credentialRead, credentialDelete, credentialUpdate } from '../../../../api/admin/credential'
...
const Credential = () => {
    ...
    useEffect(() => {
        async function fetchData() {
            let result = await credentialRead()
    ...
    const updateItem = async (id: any, status: any) => {
        ...
        let result = await credentialUpdate(data)
        if (result.isOkay) setTypeResult(result.result)
    }

    const deleteItem = async (id: any) => {
        const data = { id: id }
        let result = await credentialDelete(data)
        if (result.isOkay) setTypeResult(result.result)
    }
    ...
    return (
        <div>
            <div className="panel mt-6">
                <h5 className="font-semibold text-lg dark:text-white-light mb-4">Credential</h5>
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            { accessor: 'credential', title: 'Credential Name' },
                            {
