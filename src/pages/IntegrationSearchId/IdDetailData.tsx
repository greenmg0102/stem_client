        ...
        <div className='w-full'>
            ...
            <div className="flex justify-between items-start">
                ...
                <div className="w-full sm:w-1/4 p-8 shadow-xl border border-gray-200 border-dashed rounded-[8px]">
                    <p className="font-bold flex mb-2 text-[14px] items-center">Program School / Org Address</p>
                    <p className="mb-4">{data.schoolOrg.address}</p>
                    <p className="font-bold flex mb-2 text-[14px] items-center">Program School / Org City</p>
                    <p className="mb-4">{data.schoolOrg.city}</p>
                    <p className="font-bold flex mb-2 text-[14px] items-center">Program School / Org Post zip</p>
                    <p className="mb-4">{data.schoolOrg.zip}</p>
                    <p className="font-bold flex mb-2 text-[14px] items-center">Program School / Org Neighborhood</p>
                    <p className="mb-4">{data.schoolOrg.neighborhood}</p>
                </div>
            </div>
        </div>
    );
