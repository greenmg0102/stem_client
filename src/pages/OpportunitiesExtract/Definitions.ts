...
export const Definitions = [
    ...
    },
    {
        ...
        description: 'Dual enrollment programs allow high school students to enroll in college courses and earn credit simultaneously toward both their high school diploma and a college degree. These programs provide students with a head start on college education and can lead to significant cost savings on tuition.'
    },
    {
        title: 'Trade School',
        description: "Trade schools, also known as vocational schools or technical schools, provide students with the education and training needed for specific careers or trades. These schools focus on practical, job-specific skills and often offer programs in fields such as healthcare, technology, manufacturing, and the skilled trades."
    },
    {
        title: 'Early College',
