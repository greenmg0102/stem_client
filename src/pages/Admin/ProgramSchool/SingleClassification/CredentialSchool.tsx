...
import CredentialSchoolModal from './CredentialSchoolModal'

import { schoolRead, schoolDelete, schoolUpdate } from '../../../../api/admin/school'

const CredentialSchool = () => {
    ...
    const updateItem = async (id: any, status: any) => {
        ...
        let result = await schoolUpdate(data)
        if (result.isOkay) setTypeResult(result.result)
    }

    const deleteItem = async (id: any) => {
        const data = { id: id }
        let result = await schoolDelete(data)
        if (result.isOkay) setTypeResult(result.result)
    }
    ...
    return (
        <div>
            <div className="panel mt-6">
                <h5 className="font-semibold text-lg dark:text-white-light mb-4">Credential School</h5>
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            { accessor: 'school', title: 'School Name' },
                            {
...
export default CredentialSchool;