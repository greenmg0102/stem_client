            ...
            <div className="w-full flex justify-between items-start">
                <div className="w-full p-2">
                    ...
                    <div className="relative search-form-overlay relative border border-white-dark/20 rounded-md h-12 w-full">
                        ...
                        <div className={clsx("transition-all", Array.isArray(bufferSearchDataList) && bufferSearchDataList.length > 0 ? "absolute w-full max-h-[300px] bg-gray-50 overflow-y-auto -bottom-0 p-4 border border-blue-500 transform translate-y-full z-[99]" : "hidden border border-[0px] h-0 p-0")}>
