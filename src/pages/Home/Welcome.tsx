            ...
            >
                <div className="p-8">
                    ...
                    <div className="flex justify-around flex-wrap items-center">
                        ...
                        <NavLink to="/integration-search" className="w-[45%] text-center px-8 py-3 my-2 hover:shadow-xl text-gray-100 rounded-[6px] bg-blue-600 text-[18px] cursor-pointer transition-all">
                            <div className="flex items-center">
                                ...
                                <span className="ltr:pl-3 rtl:pr-3">Integration Search</span>
                            </div>
                        </NavLink>

                        <NavLink to="/opportunity-extract" className="w-[45%] text-center px-8 py-3 my-2 hover:shadow-xl font-bold rounded-[6px] border border-[2px] border-blue-600 text-blue-600 text-[18px] cursor-pointer transition-all">
                            <div className="flex items-center">
                        ...
                        <NavLink to="/credential-extract" className="w-[45%] text-center px-8 py-3 my-2 hover:shadow-xl font-bold rounded-[6px] border border-[2px] border-blue-600 text-blue-600 text-[18px] cursor-pointer transition-all">
                            <div className="flex items-center">
                                ...
                                <span className="ltr:pl-3 rtl:pr-3">Credential Search</span>
                            </div>
                        </NavLink>

                        <NavLink to="/general-field-extract" className="w-[45%] text-center px-8 py-3 my-2 hover:shadow-xl font-bold rounded-[6px] border border-[2px] border-blue-600 text-blue-600 text-[18px] cursor-pointer transition-all">
                            <div className="flex items-center">
                                ...
                                <span className="ltr:pl-3 rtl:pr-3">Pathways Search</span>
                            </div>
                        </NavLink>
                    </div>
                </div>
