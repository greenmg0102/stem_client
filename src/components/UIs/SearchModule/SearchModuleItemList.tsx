...
const SearchModuleItemList = ({ item }: any) => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-[20px] right-[50px]" onClick={() => setIsSelect(!isSelect)}>
                {!isSelect ?
            ...
            {isSelect &&
                ...
                <div className="flex justify-start items-start flex-wrap border border-t-[1px] border-r-[0px] border-b-[0px] border-l-[0px] border-dashed border-gray-500 py-2">
                    ...
                    <div className="border rounded-[8px] p-2 mr-2 mb-2">
                        ...
                        <p className="">{item && item.EducationLevel && item.EducationLevel.educationlevel ? item.EducationLevel.educationlevel : "N/A"}</p>
                    </div>
                    ...
                    <div className="border rounded-[8px] p-2 mr-2 mb-2">
                        ...
                        <p className="">{item && item.Age && item.Age.requirementage ? item.Age.requirementage : "N/A"}</p>
                    </div>
